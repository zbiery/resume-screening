...
class AIResumeParser(ResumeParser):
    ...
    def _parse_text(self, text: str) -> Resume:
        ...
        # Future LLM-enhanced parsing logic here
        return Resume(
            contact_info=ContactInfo(name="", email=None, phone=None, websites=None),
            synopsis=None,
            experience=None,
            skills=None
        )
    ...
    def _extract_email(self, text: str) -> Optional[str]:
        logger.debug("AIParser._extract_email is not implemented")
        return None

    def _extract_phone(self, text: str) -> Optional[str]:
        logger.debug("AIParser._extract_phone is not implemented")
        return None
    ...
    def _extract_sections(self, text: str) -> Dict[str, Any]:
        logger.debug("AIParser._extract_sections is not implemented")
        return {}
