...
#     """Factory to create an AI service instance (Groq or Azure OpenAI) based on configuration."""

#     @staticmethod
#     def create_service() -> AIServiceInterface:
#         """
#         Create and return the appropriate AI service implementation.

#         Returns:
#             An instance of GroqService or AzureOpenAIService
